...
public class TimeSheet {
	...
	/*public TimeSheet(Project project, String timeSheet_Act,
	...
	public TimeSheet(String timeSheet_Date, String timeSheet_NOHours, String timeSheet_Approved,
			String timeSheet_ApprovedBy, String timeSheet_Feedback) {
		super();
		this.timeSheet_Date = timeSheet_Date;
		this.timeSheet_NOHours = timeSheet_NOHours;
		this.timeSheet_Approved = timeSheet_Approved;
	...
	public String toString() {
		return "TimeSheet [timeSheetID=" + timeSheetID + ", project=" + project 
				+ ", timeSheet_Act=" + timeSheet_Act + ", timeSheet_Date=" + timeSheet_Date + ", timeSheet_NOHours="
				+ timeSheet_NOHours + ", timeSheet_Approved=" + timeSheet_Approved + ", timeSheet_ApprovedBy="
				+ timeSheet_ApprovedBy + ", timeSheet_Rejected_Reason=" + timeSheet_Rejected_Reason
				+ ", timeSheet_Notes=" + timeSheet_Notes + ", timeSheet_Feedback=" + timeSheet_Feedback
				+ ", timeSheet_Suggestion=" + timeSheet_Suggestion + ", timeSheet_Other_Activities="
				+ timeSheet_Other_Activities + "]";
	}
