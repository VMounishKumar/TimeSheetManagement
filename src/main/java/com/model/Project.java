...
/*	public Project(int project_ID,String project_Name, String project_notes, String project_start_date,
			String project_end_date, String project_status) {
		super();
	...
	public Project(int project_ID, String project_notes, String project_end_date) {
		super();
		this.project_ID = project_ID;
		this.project_notes = project_notes;
		this.project_end_date = project_end_date;
	...
	public String toString() {
		return "Project [project_ID=" + project_ID + ", client=" + client + ", team=" + team + ", project_Name="
				+ project_Name + ", project_client_Name=" + project_client_Name + ", project_brief=" + project_brief
				+ ", project_client_manager=" + project_client_manager + ", project_client_email="
				+ project_client_email + ", project_OS_ID=" + project_OS_ID + ", project_DB_ID=" + project_DB_ID
				+ ", project_App_server_ID=" + project_App_server_ID + ", project_manager_name=" + project_manager_name
				+ ", project_PL=" + project_PL + ", project_notes=" + project_notes + ", project_start_date="
